...
public partial class Ace52024Context : DbContext
{
    ...
    public virtual DbSet<KrinaOpassenger> KrinaOpassengers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<KrinaOpassenger>(entity =>
        {
            entity.HasKey(e => e.Oid).HasName("PK__KrinaOPa__CB3E4F3151EB5F0B");

            entity.ToTable("KrinaOPassenger");
            ...
            entity.HasOne(d => d.Book).WithMany(p => p.KrinaOpassengers)
                .HasForeignKey(d => d.Bookid)
                .HasConstraintName("FK__KrinaOPas__booki__3B60C8C7");

            entity.HasOne(d => d.Cust).WithMany(p => p.KrinaOpassengers)
                .HasForeignKey(d => d.Custid)
                .HasConstraintName("FK__KrinaOPas__custi__3A6CA48E");
        });
